...
\author{Pratham Lahoti $\cdot$ Shriya Rode $\cdot$ Aditya Kothari}
\date{\today}
...
\begin{center}
    ...
    \resizebox{0.8\textwidth}{!}{ \input{Table_1_Data_Description.tex} }
\end{center}

\begin{table}[H]
    \caption{Descriptive Statistics of Market Data}
    \vspace{0.2em}
    \begin{minipage}{0.48\textwidth} \centering \textbf{EnergyFuels} \resizebox{\linewidth}{!}{ \input{Table_4_1.tex} } \end{minipage}\hfill
    \begin{minipage}{0.48\textwidth} \centering \textbf{Arafura} \resizebox{\linewidth}{!}{ \input{Table_4_2.tex} } \end{minipage}
    \vspace{0.5em}

    \begin{minipage}{0.48\textwidth} \centering \textbf{NeoPerformance} \resizebox{\linewidth}{!}{ \input{Table_4_3.tex} } \end{minipage}\hfill
    \begin{minipage}{0.48\textwidth} \centering \textbf{Iluka} \resizebox{\linewidth}{!}{ \input{Table_4_4.tex} } \end{minipage}
    \vspace{0.5em}

    \begin{minipage}{0.48\textwidth} \centering \textbf{Shenghe} \resizebox{\linewidth}{!}{ \input{Table_4_5.tex} } \end{minipage}\hfill
    \begin{minipage}{0.48\textwidth} \centering \textbf{MPMaterials} \resizebox{\linewidth}{!}{ \input{Table_4_6.tex} } \end{minipage}
    \vspace{0.5em}

    \begin{minipage}{0.48\textwidth} \centering \textbf{Lynas} \resizebox{\linewidth}{!}{ \input{Table_4_7.tex} } \end{minipage}\hfill
    \begin{minipage}{0.48\textwidth} \centering \textbf{ChinaNorthern} \resizebox{\linewidth}{!}{ \input{Table_4_8.tex} } \end{minipage}
    \vspace{0.5em}
\end{table}

\begin{figure}[H]
    \centering \caption{Raw Rare Earth Index Price Over Time}
    \includegraphics[width=1.0\textwidth]{Figure_2_Original_Price_Series_row1.png}\\[0.2em]
    \includegraphics[width=1.0\textwidth]{Figure_2_Original_Price_Series_row2.png}\\[0.2em]
    \includegraphics[width=1.0\textwidth]{Figure_2_Original_Price_Series_row3.png}\\[0.2em]
    \includegraphics[width=1.0\textwidth]{Figure_2_Original_Price_Series_row4.png}
\end{figure}

\begin{figure}[H]
    \centering \caption{A Closer Look at the Volatility (2021)}
    \includegraphics[width=1.0\textwidth]{Figure_4_Zoomed_Price_row1.png}\\[0.2em]
    \includegraphics[width=1.0\textwidth]{Figure_4_Zoomed_Price_row2.png}\\[0.2em]
    \includegraphics[width=1.0\textwidth]{Figure_4_Zoomed_Price_row3.png}\\[0.2em]
    \includegraphics[width=1.0\textwidth]{Figure_4_Zoomed_Price_row4.png}
\end{figure}

\begin{figure}[H]
    \centering \caption{Correlation Heatmap Showing How Closely the Inputs Move Together}
    \includegraphics[width=1.0\textwidth]{Figure_5_Feature_Heatmap_row1.png}\\[0.2em]
    \includegraphics[width=1.0\textwidth]{Figure_5_Feature_Heatmap_row2.png}\\[0.2em]
    \includegraphics[width=1.0\textwidth]{Figure_5_Feature_Heatmap_row3.png}\\[0.2em]
    \includegraphics[width=1.0\textwidth]{Figure_5_Feature_Heatmap_row4.png}
\end{figure}
...
\begin{figure}[H]
    ...
    \includegraphics[width=1.0\textwidth]{Figure_3_VMD_Decomposition_row1.png}\\[0.2em]
    \includegraphics[width=1.0\textwidth]{Figure_3_VMD_Decomposition_row2.png}\\[0.2em]
    \includegraphics[width=1.0\textwidth]{Figure_3_VMD_Decomposition_row3.png}\\[0.2em]
    \includegraphics[width=1.0\textwidth]{Figure_3_VMD_Decomposition_row4.png}
\end{figure}
...
\begin{table}[H]
    ...
    \begin{minipage}{0.48\textwidth} \centering \textbf{EnergyFuels} \resizebox{\linewidth}{!}{ \input{Table_5_1.tex} } \end{minipage}\hfill
    \begin{minipage}{0.48\textwidth} \centering \textbf{Arafura} \resizebox{\linewidth}{!}{ \input{Table_5_2.tex} } \end{minipage}
    \vspace{0.5em}

    \begin{minipage}{0.48\textwidth} \centering \textbf{NeoPerformance} \resizebox{\linewidth}{!}{ \input{Table_5_3.tex} } \end{minipage}\hfill
    \begin{minipage}{0.48\textwidth} \centering \textbf{Iluka} \resizebox{\linewidth}{!}{ \input{Table_5_4.tex} } \end{minipage}
    \vspace{0.5em}

    \begin{minipage}{0.48\textwidth} \centering \textbf{Shenghe} \resizebox{\linewidth}{!}{ \input{Table_5_5.tex} } \end{minipage}\hfill
    \begin{minipage}{0.48\textwidth} \centering \textbf{MPMaterials} \resizebox{\linewidth}{!}{ \input{Table_5_6.tex} } \end{minipage}
    \vspace{0.5em}

    \begin{minipage}{0.48\textwidth} \centering \textbf{Lynas} \resizebox{\linewidth}{!}{ \input{Table_5_7.tex} } \end{minipage}\hfill
    \begin{minipage}{0.48\textwidth} \centering \textbf{ChinaNorthern} \resizebox{\linewidth}{!}{ \input{Table_5_8.tex} } \end{minipage}
    \vspace{0.5em}
\end{table}

\begin{figure}[H]
    \centering \caption{Chaos Levels (Entropy) of the Separated Modes}
    \includegraphics[width=1.0\textwidth]{Figure_8_Entropy_row1.png}\\[0.2em]
    \includegraphics[width=1.0\textwidth]{Figure_8_Entropy_row2.png}\\[0.2em]
    \includegraphics[width=1.0\textwidth]{Figure_8_Entropy_row3.png}\\[0.2em]
    \includegraphics[width=1.0\textwidth]{Figure_8_Entropy_row4.png}
\end{figure}
...
\begin{table}[H]
    ...
    \begin{minipage}{0.48\textwidth} \centering \textbf{EnergyFuels} \resizebox{\linewidth}{!}{ \input{Table_6_1.tex} } \end{minipage}\hfill
    \begin{minipage}{0.48\textwidth} \centering \textbf{Arafura} \resizebox{\linewidth}{!}{ \input{Table_6_2.tex} } \end{minipage}
    \vspace{0.5em}

    \begin{minipage}{0.48\textwidth} \centering \textbf{NeoPerformance} \resizebox{\linewidth}{!}{ \input{Table_6_3.tex} } \end{minipage}\hfill
    \begin{minipage}{0.48\textwidth} \centering \textbf{Iluka} \resizebox{\linewidth}{!}{ \input{Table_6_4.tex} } \end{minipage}
    \vspace{0.5em}

    \begin{minipage}{0.48\textwidth} \centering \textbf{Shenghe} \resizebox{\linewidth}{!}{ \input{Table_6_5.tex} } \end{minipage}\hfill
    \begin{minipage}{0.48\textwidth} \centering \textbf{MPMaterials} \resizebox{\linewidth}{!}{ \input{Table_6_6.tex} } \end{minipage}
    \vspace{0.5em}

    \begin{minipage}{0.48\textwidth} \centering \textbf{Lynas} \resizebox{\linewidth}{!}{ \input{Table_6_7.tex} } \end{minipage}\hfill
    \begin{minipage}{0.48\textwidth} \centering \textbf{ChinaNorthern} \resizebox{\linewidth}{!}{ \input{Table_6_8.tex} } \end{minipage}
    \vspace{0.5em}
\end{table}
...
\begin{table}[H]
    ...
    \begin{minipage}{0.48\textwidth} \centering \textbf{EnergyFuels} \resizebox{\linewidth}{!}{ \input{Table_7_1.tex} } \end{minipage}\hfill
    \begin{minipage}{0.48\textwidth} \centering \textbf{Arafura} \resizebox{\linewidth}{!}{ \input{Table_7_2.tex} } \end{minipage}
    \vspace{0.5em}

    \begin{minipage}{0.48\textwidth} \centering \textbf{NeoPerformance} \resizebox{\linewidth}{!}{ \input{Table_7_3.tex} } \end{minipage}\hfill
    \begin{minipage}{0.48\textwidth} \centering \textbf{Iluka} \resizebox{\linewidth}{!}{ \input{Table_7_4.tex} } \end{minipage}
    \vspace{0.5em}

    \begin{minipage}{0.48\textwidth} \centering \textbf{Shenghe} \resizebox{\linewidth}{!}{ \input{Table_7_5.tex} } \end{minipage}\hfill
    \begin{minipage}{0.48\textwidth} \centering \textbf{MPMaterials} \resizebox{\linewidth}{!}{ \input{Table_7_6.tex} } \end{minipage}
    \vspace{0.5em}

    \begin{minipage}{0.48\textwidth} \centering \textbf{Lynas} \resizebox{\linewidth}{!}{ \input{Table_7_7.tex} } \end{minipage}\hfill
    \begin{minipage}{0.48\textwidth} \centering \textbf{ChinaNorthern} \resizebox{\linewidth}{!}{ \input{Table_7_8.tex} } \end{minipage}
    \vspace{0.5em}
...
\begin{figure}[H]
    ...
    \includegraphics[width=1.0\textwidth]{Figure_6_Prediction_Plot_row1.png}\\[0.2em]
    \includegraphics[width=1.0\textwidth]{Figure_6_Prediction_Plot_row2.png}\\[0.2em]
    \includegraphics[width=1.0\textwidth]{Figure_6_Prediction_Plot_row3.png}\\[0.2em]
    \includegraphics[width=1.0\textwidth]{Figure_6_Prediction_Plot_row4.png}
\end{figure}

\begin{table}[H]
    \centering \caption{Validating Our Model Mathematically (Diebold-Mariano Test)}
    \resizebox{0.5\textwidth}{!}{ \input{Table_11_DM_Test.tex} }
\end{table}
...
\begin{table}[H]
    ...
    \begin{minipage}{0.48\textwidth} \centering \textbf{EnergyFuels} \resizebox{\linewidth}{!}{ \input{Table_8_1.tex} } \end{minipage}\hfill
    \begin{minipage}{0.48\textwidth} \centering \textbf{Arafura} \resizebox{\linewidth}{!}{ \input{Table_8_2.tex} } \end{minipage}
    \vspace{0.5em}

    \begin{minipage}{0.48\textwidth} \centering \textbf{NeoPerformance} \resizebox{\linewidth}{!}{ \input{Table_8_3.tex} } \end{minipage}\hfill
    \begin{minipage}{0.48\textwidth} \centering \textbf{Iluka} \resizebox{\linewidth}{!}{ \input{Table_8_4.tex} } \end{minipage}
    \vspace{0.5em}

    \begin{minipage}{0.48\textwidth} \centering \textbf{Shenghe} \resizebox{\linewidth}{!}{ \input{Table_8_5.tex} } \end{minipage}\hfill
    \begin{minipage}{0.48\textwidth} \centering \textbf{MPMaterials} \resizebox{\linewidth}{!}{ \input{Table_8_6.tex} } \end{minipage}
    \vspace{0.5em}

    \begin{minipage}{0.48\textwidth} \centering \textbf{Lynas} \resizebox{\linewidth}{!}{ \input{Table_8_7.tex} } \end{minipage}\hfill
    \begin{minipage}{0.48\textwidth} \centering \textbf{ChinaNorthern} \resizebox{\linewidth}{!}{ \input{Table_8_8.tex} } \end{minipage}
    \vspace{0.5em}
...
\begin{figure}[H]
    ...
    \includegraphics[width=1.0\textwidth]{Figure_9_Cumulative_Return_Basic_row1.png}\\[0.2em]
    \includegraphics[width=1.0\textwidth]{Figure_9_Cumulative_Return_Basic_row2.png}\\[0.2em]
    \includegraphics[width=1.0\textwidth]{Figure_9_Cumulative_Return_Basic_row3.png}\\[0.2em]
    \includegraphics[width=1.0\textwidth]{Figure_9_Cumulative_Return_Basic_row4.png}
\end{figure}

\begin{figure}[H]
    \centering \caption{Equity Curve: How Our Interval Strategy Steered Clear of Crashes}
    \includegraphics[width=1.0\textwidth]{Figure_10_Cumulative_Return_Interval_row1.png}\\[0.2em]
    \includegraphics[width=1.0\textwidth]{Figure_10_Cumulative_Return_Interval_row2.png}\\[0.2em]
    \includegraphics[width=1.0\textwidth]{Figure_10_Cumulative_Return_Interval_row3.png}\\[0.2em]
    \includegraphics[width=1.0\textwidth]{Figure_10_Cumulative_Return_Interval_row4.png}
\end{figure}

\begin{figure}[H]
    \centering \caption{Maximum Drawdowns (Notice how the worst losses are avoided)}
    \includegraphics[width=1.0\textwidth]{Figure_11_Drawdown_row1.png}\\[0.2em]
    \includegraphics[width=1.0\textwidth]{Figure_11_Drawdown_row2.png}\\[0.2em]
    \includegraphics[width=1.0\textwidth]{Figure_11_Drawdown_row3.png}\\[0.2em]
    \includegraphics[width=1.0\textwidth]{Figure_11_Drawdown_row4.png}
\end{figure}
...
\begin{table}[H]
    ...
    \resizebox{0.5\textwidth}{!}{ \input{Table_9_Transaction_Cost.tex} }
\end{table}

\begin{table}[H]
    \caption{Robustness Check: Sliding Window Performance}
    \begin{minipage}{0.48\textwidth} \centering \textbf{EnergyFuels} \resizebox{\linewidth}{!}{ \input{Table_10_1.tex} } \end{minipage}\hfill
    \begin{minipage}{0.48\textwidth} \centering \textbf{Arafura} \resizebox{\linewidth}{!}{ \input{Table_10_2.tex} } \end{minipage}
    \vspace{0.5em}

    \begin{minipage}{0.48\textwidth} \centering \textbf{NeoPerformance} \resizebox{\linewidth}{!}{ \input{Table_10_3.tex} } \end{minipage}\hfill
    \begin{minipage}{0.48\textwidth} \centering \textbf{Iluka} \resizebox{\linewidth}{!}{ \input{Table_10_4.tex} } \end{minipage}
    \vspace{0.5em}

    \begin{minipage}{0.48\textwidth} \centering \textbf{Shenghe} \resizebox{\linewidth}{!}{ \input{Table_10_5.tex} } \end{minipage}\hfill
    \begin{minipage}{0.48\textwidth} \centering \textbf{MPMaterials} \resizebox{\linewidth}{!}{ \input{Table_10_6.tex} } \end{minipage}
    \vspace{0.5em}

    \begin{minipage}{0.48\textwidth} \centering \textbf{Lynas} \resizebox{\linewidth}{!}{ \input{Table_10_7.tex} } \end{minipage}\hfill
    \begin{minipage}{0.48\textwidth} \centering \textbf{ChinaNorthern} \resizebox{\linewidth}{!}{ \input{Table_10_8.tex} } \end{minipage}
    \vspace{0.5em}
...
\begin{figure}[H]
    ...
    \includegraphics[width=1.0\textwidth]{Figure_13_Robustness_Check_row1.png}\\[0.2em]
    \includegraphics[width=1.0\textwidth]{Figure_13_Robustness_Check_row2.png}\\[0.2em]
    \includegraphics[width=1.0\textwidth]{Figure_13_Robustness_Check_row3.png}\\[0.2em]
    \includegraphics[width=1.0\textwidth]{Figure_13_Robustness_Check_row4.png}
\end{figure}

\begin{table}[H]
    \centering \caption{The Deep Learning Engine Settings We Used Under the Hood}
    \resizebox{0.5\textwidth}{!}{ \input{Table_12_Parameters.tex} }
\end{table}
...
\\begin{figure}[H]
\\centering
\\includegraphics[width=0.48\\linewidth]{Figure_13_Robustness_Check_row1.png}\\hfill
\\includegraphics[width=0.48\\linewidth]{Figure_13_Robustness_Check_row2.png}
\\vspace{0.2cm}
\\includegraphics[width=0.48\\linewidth]{Figure_13_Robustness_Check_row3.png}\\hfill
\\includegraphics[width=0.48\\linewidth]{Figure_13_Robustness_Check_row4.png}
